                ...
                <form action="{{ route('submit-package-withdraw-request') }}" onsubmit="return checkValue()" method="Post">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                                                <textarea type="text" class="form-control" id="packageTerms"
                                                                          readonly></textarea>
                                            <button type="button" class="btn btn-primary mt-3" data-bs-dismiss="modal" style="float: right">I Agree</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12 withdraw" style="display: none">
                            <label for=""  class="font-medium font-15 color-heading">Select Withdrawal Method</label>
                            <div class="row">
                                <div class="col-md-5">
