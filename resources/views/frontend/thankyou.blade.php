...
{{--  <meta property="og:image" content="uploads/setting/1694024691-8uKkZXEOM9.png">--}}

{{--  <meta name="twitter:card" content="Learning">--}}
{{--  <meta name="twitter:title" content="">--}}
{{--  <meta name="twitter:description" content="Learning and Earning Platform">--}}
{{--  <meta name="twitter:image" content="uploads/setting/1694024691-8uKkZXEOM9.png">--}}

{{--  <meta name="msapplication-TileImage" content="uploads/setting/1694024691-8uKkZXEOM9.png">--}}
...
{{--  <link rel="stylesheet" href="{{ asset('frontend') }}/common/css/summernote/summernote.min.css">--}}
{{--  <link rel="stylesheet" href="{{ asset('frontend') }}/common/css/summernote/summernote-lite.min.css">--}}
...
{{--  <link rel="icon" href="uploads/setting/1694024590-cPqN0ugw1I.png" type="image/png" sizes="16x16">--}}
{{--  <link rel="shortcut icon" href="uploads/setting/1694024590-cPqN0ugw1I.png" type="image/x-icon">--}}
{{--  <link rel="shortcut icon" href="uploads/setting/1694024590-cPqN0ugw1I.png">--}}
{{--  <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="uploads/setting/1694024590-cPqN0ugw1I.png"--}}
{{--    sizes="72x72">--}}
{{--  <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="uploads/setting/1694024590-cPqN0ugw1I.png"--}}
{{--    sizes="114x114">--}}
{{--  <link rel="apple-touch-icon-precomposed" type="image/x-icon" href="uploads/setting/1694024590-cPqN0ugw1I.png"--}}
...
{{--  <link rel="stylesheet" href="{{ asset('frontend') }}/css/vendor/datatable/datatables-buttons/css/buttons.bootstrap4.min.css">--}}
...
{{--                            </h2>--}}
{{--                            <p>You need to wait untill admin review your profile</p>--}}
{{--                            <div class="my-5 text-black">--}}
{{--                                                                <div class="my-2">--}}
{{--                                    <p><span class="font-bold"> Name:</span> {{ $thankyou->first_name }}</p>--}}
{{--                                </div>--}}
{{--                                                                                                <div class="my-2">--}}
{{--                                    <p><span class="font-bold"> Phone Number:</span> {{ $thankyou->phone }}</p>--}}
{{--                                </div>--}}

{{--                                                                <div class="my-2">--}}
{{--                                    <p><span class="font-bold"> Email:</span> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" >{{ $thankyou->email}}</a></p>--}}
{{--                                </div>--}}
...
{{--                                </div> --}}
{{--                                                                <div class="my-4">--}}
{{--                                    <a href="{{ route('home') }}" class="theme-btn theme-button1 theme-button3 font-15 fw-bold w-100">Go to home</a>--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--  <script src="{{ asset('frontend') }}/common/js/summernote/summernote-lite.min.js"></script>--}}
...
{{--  <script src="{{ asset('frontend') }}/css/vendor/datatable/datatables-responsive/js/responsive.bootstrap4.min.js"></script>--}}
...
{{--  <!-- Hero Text -->--}}
{{--  <script src="{{ asset('frontend') }}/css/js/hero-text-effect.js"></script>--}}
...
{{--  <script src="{{ asset('frontend') }}/css/js/custom/booking.js"></script>--}}
...
{{--  <!-- Video Player js -->--}}
{{--  <script src="frontend/assets/vendor/video-player/plyr.js"></script>--}}
...
@section('content')
    <main>
        <!-- success Area Start -->
        <section class="sign-up-page pt-3">
            <div class="container-fluid p-0">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card card-body">
                            <div class="d-flex justify-content-center align-items-center my-5">
                                ...
                                <div class="shadow p-3 rounded">
                                    ...
                                    <p class="text-center">You need to wait untill admin review your profile</p>
                                    <div class="my-5 text-black text-center">
                                        ...
                                        <div class="my-4 text-center">
                                            <a href="{{ route('home') }}" class="btn font-15 fw-bold  text-white" style="background: #95cd41">Go to home</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
