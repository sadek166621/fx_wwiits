...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
    ...
    <style>
        ...
        #navbarSupportedContent .menu-cart-btn {
            margin: 10px;
        }
...
===========================================-->
    ...
    <!--<script src="{{ asset('frontend') }}/admin/sweetalert2/sweetalert2.all.js"></script>-->
  ...
  <body>
     ...
     @include('frontend.include.header')
      ...
      <script src="{{asset('new-assets')}}/assets/js/main.js"></script>
        <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
        <script src="{{asset('new-assets')}}/assets/js/owl.carousel.min.js"></script>
        <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css">
        <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/js/toastr.min.js"></script>
        {!! Toastr::message() !!}
