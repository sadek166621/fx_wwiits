    ...
    <section>
        <div class="row">
            <div class="col-12 col-md-5">
                <div class="nav-background" style="background: #000a26">
                    <div class="">
                    ...
                    <h3 class="text-light fw-medium p-4">Learn Forex Trading With Effective Learning Tools & Methods From FX WWIITS.</h3>
                    <div class="">
                        <img src="{{asset('frontend')}}/images/signin-image.jpg" alt="hero" class="img-fluid w-100">
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-7 p-5 p-md-0 p-lg-5">
                <div class="col-md-8 mt-3 mt-md-4 pt-3 pt-md-4">
                    ...
                    <p class="" style="color: #141435;">New User ? <a class="" style="color: #95cd41;" href="{{ route('student.signup') }}">Create an Account</a></p>
                </div>
                @if ($errors->any())
                ...
                <div class="row mt-2 mt-md-3 pt-2 pt-md-3">
                    <div class="col-md-8">
                        <button type="submit" class="btn fw-bold w-100 my-2 p-2 bg-opacity-50" style="background: #95cd41;">Sign In</button>
                    </div>
                    {{-- <div class="col-md-8">
